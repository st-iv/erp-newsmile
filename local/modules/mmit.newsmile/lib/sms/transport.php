...
class Transport
{
    ...
    const HTTPS_ADDRESS = 'https://lcab.sms-uslugi.ru/';
    const HTTP_ADDRESS = 'http://lcab.sms-uslugi.ru/';
    ...
    function send($params = array(), $phones = array()){
        ...
        $someXML = "";
        if (isset($params["text"])) $params["text"] = htmlspecialchars($params["text"],null,self::HTTPS_CHARSET);
    ...
    function makeXML($params,$someXML = ""){
		...
		<data>
			<login>".Config::getOption('sms_auth_login')."</login>
			<password>".Config::getOption('sms_auth_pass')."</password>
			";
